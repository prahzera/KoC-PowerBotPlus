...
var TabIcons = {
	...
	Throne: '<path d="M5 3 H19"/><path d="M6 3 V8 H18 V3"/><path d="M7 8 V21 H17 V8"/><path d="M12 8 V21"/>',
	Boss: '<path d="M4 14 L6 4 L11 8 L12 2 L13 8 L18 4 L20 14 Z"/><path d="M6 15 H18 V19 H6 Z"/>',
	Champ: '<path d="M15 3 H9 V9 A3 3 0 0 0 15 9 Z"/><path d="M9 6 H5 A2 2 0 0 0 7 8 H9 M15 6 H19 A2 2 0 0 1 17 8 H15"/><path d="M12 12 V15"/><path d="M9 17 H15"/>',
	Boss: '<path d="M2 19 H22"/><path d="M4 19 V8 H7 V13 H9 V5 H12 V13 H14 V5 H17 V13 H19 V8 H22 V19 Z"/>',
	Champ: '<path d="M8 4 H16 V9 A4 4 0 0 1 8 9 Z"/><path d="M8 7 H4 A2 2 0 0 0 6 9 H8 A8 8 0 0 0 16 9 H18 A2 2 0 0 0 20 7 H16"/><path d="M12 13 V18"/><path d="M9 17 H15"/>',
